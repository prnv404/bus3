...
export class BusService {
    ...
    constructor(private readonly busRepository: BusRepository,private readonly depotRepsitory:DepotRepository) { }
    ...
    async CreateBus(data:BusAttrs) {
        ...
        const Depot = await this.depotRepsitory.findByDepotCode(data.depotCode)

        if (!Depot) throw new BadRequestError("Depot Not found !")
        
        Depot.buses.push(bus.id)
